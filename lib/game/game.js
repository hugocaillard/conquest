...
var game = {
  ...
  */
  ...
  tweet: function(winner) {
    ...
    var tweets = [
      'Another epic battle just ended on #Conquest! Come and join the space explorers to conquer new territories http://conquest.io/lobby',
      'Team '+winner+' just won a massive war on #Conquest! Join or fight them, and reign over the space http://conquest.io/lobby',
      'A new conflict is starting up on #Conquest in '+app.config.game.countdown+' minutes! Take part in this epic war and reign over the space http://conquest.io/lobby'
    ];
